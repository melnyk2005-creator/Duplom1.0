...
Усі коментарі та назви об'єктів у цьому проєкті використовують англійську мову. Проєкт містить міграційні скрипти, процедури, функції, тригери та події для бази даних MySQL.
